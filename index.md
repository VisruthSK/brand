...
exports
[`brand::use_brand()`](https://brand.visruth.com/reference/use_brand.md),
...
1.  The actual
    [`inst/_brand.yml`](https://brand.visruth.com/inst/_brand.yml)
2.  The files in [`inst/fonts/`](https://brand.visruth.com/inst/fonts),
    which Typst needs for any family you self-host (I serve mine from
    <https://www.visruth.com>; families on [Google
    Fonts](https://fonts.google.com) need nothing here)
3.  [`_pkgdown.yml`](https://brand.visruth.com/_pkgdown.yml),
    specifically the url;
    [`inst/pkgdown/_pkgdown.yml`](https://brand.visruth.com/inst/pkgdown/_pkgdown.yml),
    removing the Links and Bluesky entries from both `navbar.structure`
    and `navbar.components`; and
    [`website/_quarto.yml`](https://brand.visruth.com/website/_quarto.yml)
    plus [`website/setup.R`](https://brand.visruth.com/website/setup.R),
...
at least pass `override = brand::pkgdown_override()` to pkgdown. A plain
