...
5. Minor changes to the playwright testing setup, in addition to regenerating snapshots when you finalize your theme.
6. Optionally, this [`README.md`](README.md)!
