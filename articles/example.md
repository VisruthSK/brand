...
Paragraph text should use the brand base font. Inline code should use
the brand monospace: `const x = 42`.
...
> Blockquote example. This should remain readable in both light and dark
> modes.
